**Báo cáo tiến độ hàng tuần**<br>

**Tuần 1:** 
- Lựa chọn đề tài và tìm hiểu lý thuyết về **Machine Learning**.
- Tìm hiểu lý thuyết, tài liệu liên quan **MNIST** và **KNN**.
- Làm sườn bài trên file `.docx`.
- Tạo repository trên Github.

**Tuần 2:** <br>
- Thực hiện cài đặt phần mềm Python, VS Code.
- Tạo môi trường `venv`.
...
- Bổ sung thêm phần test nhiều giá trị _K_ và cho ra best _K_.
